    ...
    <div>
      <div className="anim-fadein">
        <div style={{ background: 'linear-gradient(135deg, #1E2775 0%, #161C5C 100%)', borderRadius: 16, padding: '20px 24px', marginBottom: 18, display: 'flex', alignItems: 'center', gap: 16, boxShadow: '0 8px 24px rgba(22, 28, 92, 0.15)', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ background: 'rgba(30,200,165,0.2)', border: '1px solid rgba(30,200,165,0.35)', borderRadius: 10, padding: '10px 20px', textAlign: 'center', flexShrink: 0, position: 'relative', zIndex: 1 }}>
            <div style={{ color: '#1EC8A5', fontSize: 22, fontWeight: 800, lineHeight: 1 }}>{nakesItems.filter(d => d.status === 'active').length}</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '420px 1fr', gap: 16 }}>
          ...
          {/* Form Registrasi */}
          <div style={{ background: 'rgba(255,255,255,0.72)', backdropFilter: 'blur(14px) saturate(1.5)', WebkitBackdropFilter: 'blur(14px) saturate(1.5)', borderRadius: 16, padding: 22, boxShadow: '0 8px 24px rgba(15,36,68,0.06)', border: '1px solid rgba(255,255,255,0.75)', height: 'fit-content' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18 }}>
              <div>
                ...
                <div style={{ fontSize: 11, color: '#8A93A1', marginTop: 2 }}>Daftarkan dokter baru</div>
              </div>
              <button
                onClick={() => ocrInputRef.current?.click()}
                disabled={ocrLoading}
                style={{ display: 'flex', alignItems: 'center', gap: 7, background: ocrLoading ? 'rgba(241,245,249,0.75)' : '#EEEFFE', border: '1.5px dashed #5B6BF0', borderRadius: 9, padding: '8px 13px', cursor: ocrLoading ? 'not-allowed' : 'pointer', color: '#5B6BF0', fontSize: 12, fontWeight: 600 }}
              >
                {ocrLoading ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 13 }}>
              <div>
                ...
                <input
                  ...
                  style={{ width: '100%', padding: '10px 13px', border: `1.5px solid ${drErr('name') ? '#EF4444' : '#DCDFE8'}`, borderRadius: 9, fontSize: 13, color: '#2B2D42', background: 'rgba(255,255,255,0.6)', outline: 'none', boxSizing: 'border-box' }}
                />
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                <div>
                  ...
                  <input
                    ...
                    maxLength={16}
                    style={{ width: '100%', padding: '10px 13px', border: `1.5px solid ${drErr('nik') ? '#EF4444' : '#DCDFE8'}`, borderRadius: 9, fontSize: 13, color: '#2B2D42', background: 'rgba(255,255,255,0.6)', outline: 'none', fontFamily: 'monospace', letterSpacing: '1px', boxSizing: 'border-box' }}
                  />
              ...
              <div>
                ...
                <input
                  ...
                  style={{ width: '100%', padding: '10px 13px', border: `1.5px solid ${drErr('alamat') ? '#EF4444' : '#DCDFE8'}`, borderRadius: 9, fontSize: 13, color: '#2B2D42', background: 'rgba(255,255,255,0.6)', outline: 'none', boxSizing: 'border-box' }}
                />
              ...
              <div>
                ...
                <input
                  ...
                  style={{ width: '100%', padding: '10px 13px', border: `1.5px solid ${drErr('phone') ? '#EF4444' : '#DCDFE8'}`, borderRadius: 9, fontSize: 13, color: '#2B2D42', background: 'rgba(255,255,255,0.6)', outline: 'none', boxSizing: 'border-box' }}
                />
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                <div>
                  ...
                  <input
                    ...
                    style={{ width: '100%', padding: '10px 13px', border: `1.5px solid ${drErr('username') ? '#EF4444' : '#DCDFE8'}`, borderRadius: 9, fontSize: 13, color: '#2B2D42', background: 'rgba(255,255,255,0.6)', outline: 'none', boxSizing: 'border-box' }}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    style={{ width: '100%', padding: '10px 13px', border: `1.5px solid ${drErr('password') ? '#EF4444' : '#DCDFE8'}`, borderRadius: 9, fontSize: 13, color: '#2B2D42', background: 'rgba(255,255,255,0.6)', outline: 'none', boxSizing: 'border-box' }}
                  />
          ...
          <div style={{ background: 'rgba(255,255,255,0.72)', backdropFilter: 'blur(14px) saturate(1.5)', WebkitBackdropFilter: 'blur(14px) saturate(1.5)', borderRadius: 16, boxShadow: '0 8px 24px rgba(15,36,68,0.06)', border: '1px solid rgba(255,255,255,0.75)', overflow: 'hidden' }}>
            <div style={{ padding: '16px 20px', borderBottom: '1px solid #F4F5F7', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <button
                ...
                style={{ display: 'flex', alignItems: 'center', gap: 5, background: 'rgba(241,245,249,0.75)', border: '1px solid #DCDFE8', borderRadius: 8, padding: '6px 12px', fontSize: 11, fontWeight: 600, color: '#636B78', cursor: nakesLoading ? 'not-allowed' : 'pointer' }}
              >
              ...
              {!nakesLoading && nakesItems.map(doc => {
                ...
                return (
                  <div key={doc.nakes_id} onClick={() => handleSelectNakes(doc.nakes_id)} style={{ display: 'flex', alignItems: 'center', gap: 13, padding: '14px 20px', borderBottom: '1px solid #F4F5F7', opacity: isActive ? 1 : 0.55, cursor: 'pointer' }} onMouseEnter={e => (e.currentTarget.style.background = '#F7F8FF')} onMouseLeave={e => (e.currentTarget.style.background = '')}>
                    ...
                    <span style={{
                      flexShrink: 0,
                      background: isActive ? '#F0FDF8' : 'rgba(255,255,255,0.6)',
      ...
      {nakesToToggle && (
        ...
        >
          <div style={{ background: '#ffffff', borderRadius: 16, padding: 28, width: 400, maxWidth: '90vw', boxShadow: '0 20px 60px rgba(15,36,68,0.25)', border: '1px solid rgba(255,255,255,0.8)' }}>
            {(() => {
              ...
              return (
                <>
                  ...
                  <div style={{ background: 'rgba(255,255,255,0.6)', borderRadius: 10, padding: '12px 14px', marginBottom: 22, fontSize: 13, color: '#636B78', lineHeight: 1.55 }}>
                    {isActive
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                    <button
                      ...
                      style={{ padding: '11px 0', background: 'rgba(241,245,249,0.75)', border: '1px solid #DCDFE8', borderRadius: 10, fontSize: 14, fontWeight: 600, color: '#636B78', cursor: toggleLoading ? 'not-allowed' : 'pointer' }}
                    >
                      Batal
                    </button>
                    <button
      ...
      {registerResult && (
        <div
          ...
          style={{ position: 'fixed', inset: 0, background: 'rgba(23,28,58,0.62)', zIndex: 2000, display: 'flex', alignItems: 'center', justifyContent: 'center', backdropFilter: 'blur(6px)', WebkitBackdropFilter: 'blur(6px)', animation: 'fadeIn 0.2s ease-out' }}
        >
          <div style={{ background: '#ffffff', borderRadius: 16, padding: 28, width: 440, maxWidth: '90vw', boxShadow: '0 20px 60px rgba(15,36,68,0.25)', display: 'flex', flexDirection: 'column' }}>
            ...
            <button
              ...
              style={{
                width: '100%', padding: '11px 0', background: 'rgba(241,245,249,0.75)', border: '1px solid #DCDFE8',
